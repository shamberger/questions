...
*/
import chromeFavicon from 'images/chrome-192-precomposed.png';
...
const metaAssets = () => {
  return [
    ...
    { "name": "description", "content": "Приложение для огранизации связи сотрудников и начальства в виде Вопрос - Ответ"},
...
const linkAssets = () => {
  const links = [
    ...
    { "rel": "stylesheet", "href": "https://cdnjs.cloudflare.com/ajax/libs/bulma/0.2.3/css/bulma.css" }
